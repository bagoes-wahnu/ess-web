...
class CreatePermohonanEvaluasiSurveyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('permohonan_evaluasi_survey', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('permohonan_evaluasi_survey');
    }
}
