    ...
    <div class="card mb-5 mb-xxl-8">
        <div class="card-header border-0 py-5">
            ...
            <div class="card-toolbar">
                <button id="btn-create" class="btn btn-primary font-weight-bolder font-size-sm mr-2" onclick="create()">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12" id="pointer-alert">
                    <div class="alert alert-dismissible bg-light-primary d-flex flex-column flex-sm-row p-3 mb-5">
                        <span class="svg-icon svg-icon-2hx svg-icon-primary me-4 mb-5 mb-sm-0 mt-2">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <div class="d-flex flex-column pe-0 pe-sm-10" style="justify-content: center;">
                            {{--<h4 class="fw-bold">This is an alert</h4>--}}
                            <span>Silahkan pilih tipe terlebih dahulu.</span>
                        </div>
                ...
                <div class="col-md-12 mb-2" id="div-nama">
                    <label>Masukkan alamat kantor</label>
                    <label class="fs-8 text-muted mb-3">Jika lokasi tidak tersedia, silahkan tandai langsung pada maps</label>
                    {{--<input type="text" class="form-control" id="txt-name" placeholder="Masukkan Alamat"/>--}}
                    <input
                    id="pac-input-modal"
                    class="controls form-control"
                    type="text"
                ...
                <div class="col-md-12 d-none" id="div-map">
                    <div id="map-modal" style="width:100%;min-height:500px;"></div>
                </div>
            </div>
            ...
            <div class="modal-footer row mx-0" style="justify-content: space-between;">
                <div class="col-4 p-0">
                    <button  class="btn btn-danger font-weight-bolder font-size-sm mr-2 d-none" id="btn-hapus" onclick="hapusLokasi()">Hapus Lokasi</button>
                </div>
                <div class="col-7 text-right p-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button  class="btn btn-primary font-weight-bolder font-size-sm mr-2" id="btn-simpan" onclick="simpanNama()">Simpan Lokasi</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="https://maps.google.com/maps/api/js?key=AIzaSyBDHDV2ksjKZ8xtSOZEOBe4_DQM87VrXgI&libraries=places,drawing&callback=renderMap" async defer></script>
