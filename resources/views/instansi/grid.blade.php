    ...
    <div class="card mb-5 mb-xxl-8" style="background: #FFFFFF;box-shadow: 0px 0px 30px rgba(56, 71, 109, 0.1);border-radius: 12px;">
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label text-dark font-weight-bolder" style="font-size:20px">Master Instansi</span></br>
                <span class="text-muted" style="font-size:16px">Berikut merupakan master instansi pada aplikasi KSI - ESS</span>
            </h3>
            ...
            <form id="form-input">
                <div class="modal-body">
                    ...
                    <div class="form-group  mb-4">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Masukkan nama instansi"/>
                    </div>
                    <div class="form-group  mb-4">
                        <label for="nama" class="form-label">Nama Alamat</label>
                        <textarea class="form-control" id="address" rows="3" placeholder="Masukkan alamat lengkap instansi"></textarea>
                    </div>
                </div>
...
<script src="{{asset('assets/extends/js/pages/instansi.js')}}"></script>
