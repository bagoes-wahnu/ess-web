    ...
    <div class="card mb-5 mb-xxl-8" style="background: #FFFFFF;box-shadow: 0px 0px 30px rgba(56, 71, 109, 0.1);border-radius: 12px;">
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label text-dark font-weight-bolder" style="font-size:20px">Permohonan Izin</span></br>
                <span class="text-muted" style="font-size:16px">Berikut merupakan permohonan izin pada aplikasi KSI - ESS</span>
            </h3>
...
<script src="{{asset('assets/extends/js/pages/permohonan-izin.js')}}"></script>
