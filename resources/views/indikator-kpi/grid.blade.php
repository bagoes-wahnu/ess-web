    ...
    <div class="card mb-5 mb-xxl-8" style="background: #FFFFFF;box-shadow: 0px 0px 30px rgba(56, 71, 109, 0.1);border-radius: 12px;">
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label text-dark font-weight-bolder" style="font-size:20px"> Indikator KPI</span></br>
                <span class="text-muted" style="font-size:16px">Berikut merupakan indikator kpi pada aplikasi KSI - ESS</span>
            </h3>
                	...
                	<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                		<thead>
	                		<tr class="font-weight-bolder text-center">
	                			<th scope="col">No</th>
	                			<th scope="col">Jenis Parameter</th>
	                			<th scope="col">Prespektif</th>
                		...
                		<tbody>
	                		<tr>
                                ...
                                <td>Pengendalian Biaya cost center (by konsultan, by rapat, cosumable dll)</td>
                            ...
                            <tr>
                                ...
                                <td>Customer</td>
                                <td>Melakukan pendampingan perizinan investor</td>
                                <td class="text-center"> 
                                    <div style="padding: 0 3rem;">
                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                            {{-- <input class="form-check-input" type="checkbox" value="" onclick="changeStatus()"/> --}}
                                ...
                                <ul class="nav">
                                    <div class="row" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
                                        ...
                                        <div class="col-6 w-375px">
                                            <label id="label-prespektif" class="mt-2 btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6 me-2" data-bs-toggle="tab" href="#kt_widget_tab_2" data-kt-button="true">
                                                <span class="form-check form-check-custom form-check-sm align-items-middle mt-1">
                                                    <input class="form-check-input menu-2" type="radio" name="type" value="2" onclick="perspective()"/>
                                                </span>
                                                <span class="ms-5 mt-2">
                                                    <span class="fs-4 fw-bolder text-gray-800 mb-2 d-block">Prespektif</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center px-5">
                                                ...
                                                <br />Silahkan pilih menu diatas untuk membuat data indikator kpi</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade menu-form" id="kt_widget_tab_1">
                                    <div class="col-md-12 fv-row">
                                        <label class="fs-5 fw-bold mt-5 mb-2">Jenis Parameter</label>
                                        <input id="nama-parameter" type="text" class="form-control mb-5" name="row-name" placeholder="Cth: Finance"/>
                                    </div>
                                </div>
                                <div class="tab-pane fade menu-form" id="kt_widget_tab_2">
                                    <div class="d-flex flex-column fv-row">
                                        ...
                                        <div class="d-none" id="parameter-edit">
                                            <select class="form-select " id="select-parameter-edit" data-control="select2" data-placeholder="Pilih jenis parameter" onchange="changeName()">
                                            </select>
                                        </div>
                                        <div id="parameter-add">
                                            <select class="form-select" id="select-parameter" data-control="select2" data-placeholder="Pilih jenis parameter">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
...
<script src="{{asset('assets/extends/js/pages/indikator-kpi.js')}}"></script>
@endsection