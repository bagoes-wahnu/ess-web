...
jQuery(document).ready(function() {
    $('#mn-poin-karyawan').addClass('active')
    $('a#mn-poin-karyawan .menu-icon').addClass('svg-icon svg-icon-2x svg-icon-primary')
    $('a#mn-poin-karyawan .menu-title').addClass('text-primary font-weight-bolder').removeClass('menu-title')
    ...
    $(document).on("click", '#btn-filter', function (e) {
        ...
        if($('#tahun').val()!==''&&$('#divisi').val()!=='Pilih Divisi'){
            ...
            $('#div-empty .use-filter-please').removeClass('d-none')
            $('.table-poin').addClass("d-none")
            swal.fire({
                title: "Opps..",
                text: "Harap memilih tahun dan divisi",
                icon: "warning",
            })
        }
    });
    ...
    $.ajax({
        ...
        ewpLoadingHide();
            ...
            if(res.length>0){
                ...
                loaderInit("end")
                $('#div-empty').removeClass("d-none")
                $('#div-empty .use-filter-please').addClass('d-none')
                $('.table-poin').addClass("d-none")
                is_empty=true
            }
        },
